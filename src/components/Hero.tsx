  ...
  return (
    <section id="home" className="relative flex items-center pt-28 pb-12 overflow-hidden w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Menggunakan flex dengan justify-between agar konten rapat dan proporsional */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          ...
          {/* Right Content (Gambar) - Aspect ratio 4/5 membuatnya memanjang ke bawah */}
          <motion.div
          ...
          >
            {/* ASPECT-[4/5] MEMBUAT GAMBAR LEBIH TINGGI/PENUH */}
            <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-white w-full">
              <img
                src="/homepict.png"
            ...
            {/* Floating Card - Dipindah lebih ke bawah (bottom-12) agar lebih dinamis */}
            <motion.div
              animate={{ y: [0, -10, 0] }}
              transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
              className="absolute bottom-12 -left-6 md:-left-8 bg-white p-5 rounded-2xl shadow-xl border border-brand-beige max-w-[180px]"
            >
