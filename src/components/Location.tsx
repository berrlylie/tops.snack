      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {/* EMBED GOOGLE MAPS */}
            <iframe
              src="<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d494.58989717164644!2d109.233295!3d-7.385334!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xaf1442cbe45d1e9%3A0xb295aea929e24fae!2sTops%20Snack!5e0!3m2!1sid!2sid!4v1779443541348!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"
              width="100%"
              height="100%"
              style={{ border: 0 }}
